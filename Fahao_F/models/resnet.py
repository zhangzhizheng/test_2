...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        with open('/home/test_2/time/convo_1_'+str(self.in_planes/64+self.a)+'.pkl', 'ab') as f:
            #print('a')
        ...
        with open('/home/test_2/time/convo_2_'+str(self.in_planes/64+self.a)+'.pkl', 'ab') as f:
            #print('a')
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        with open('/home/test_2/time/convo_0_1.pkl', 'ab') as f:
                #print('a')
                pickle.dump(conv1, f)
