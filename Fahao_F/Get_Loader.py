...
class Get_Loader(object):
    ...
    def get_dataloader(self):
        ...
        if(self.args.iid == 0):
            ...
            print("nonidnonidnonidnonidnonidnonidnonidnonidnonidnonidnonidnonidnonid")
    ...
    def cifar_noniid(self):
        ...
        for i in range(self.args.num_users):
            ...
            for j in distribution_data[self.args.data_distribution]:   #0 -> i, 每个client随机  , i->0 ,改固定, 加上users_list[i]每个分配 self.args.data_distribution
        ...
        for i in range(self.args.num_users):
            ad = 0
            for j in distribution_data[self.args.data_distribution]:  #0 -> i, 每个client随机
